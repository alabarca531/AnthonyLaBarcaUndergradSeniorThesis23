...
function. The output of the network is another vector tailored for the particular purpose of the FCN (i.e. for classification, the output is a vector of probabilities 
that the input data belongs to, see Appendix~\ref{app:FCN}). 

The FCN architecture, while simplistic, is very powerful. \textcite{cybenko1989} showed that for any boolean 
...
many fields, but it is also the reason that FCNs are not the best choice for all problems.

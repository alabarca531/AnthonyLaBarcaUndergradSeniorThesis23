...
These datasets with a signal-to-noise of 10 were trivially separable by a smaller Spectral ViT architecture, 
...
\begin{figure}[h]
    \centering
    \subfloat[\centering~SNR = 2]{\includegraphics[width=10cm]{figures/pre_testing/SN2_example.png}}
    \qquad
    \subfloat[\centering~SNR=10]{\includegraphics[width=10cm]{figures/pre_testing/SN10_example.png}}
...
\begin{figure}[h]
    \centering
    \subfloat[\centering~SNR = 2]{\includegraphics[width=10cm]{figures/pre_testing/SNR2_training_epoch.png}}
    \qquad
    \subfloat[\centering~SNR=10]{\includegraphics[width=10cm]{figures/pre_testing/SNR10_training_epoch.png}}
    \caption{Synthetic spectra used to verify performance of SpectralViT\label{fig:synth_spectra}}
\end{figure}
